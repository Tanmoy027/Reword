...
class ProfileUpdateUser extends StatefulWidget {
  const ProfileUpdateUser({super.key});

  @override
  State<ProfileUpdateUser> createState() => _ProfileUpdateUserState();
}

class _ProfileUpdateUserState extends State<ProfileUpdateUser> {
  // Controllers for the text fields
  final TextEditingController _nameController = TextEditingController();
  final TextEditingController _emailController = TextEditingController();

  File? _selectedImage; // Holds the chosen image file
  Uint8List? _profileImageBytes; // Holds the base64-decoded image data
  ...
  Future<void> _updateProfile() async {
    ...
    try {
      ...
      if (_selectedImage != null) {
        ...
        // No image selected, update profile without image
